...
- Android plugins can define JVM subclasses and interface implementations with instance/static fields, constructors, and JS or interpreted-routine method bodies (`inu.jvm.defineClass`, unscoped `unsafe.jvm`)
