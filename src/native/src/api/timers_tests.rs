...
type Fixture =
    (Runtime, Context, Rc<TestTimerHost>, Rc<Lifecycle>, Disposing, std::sync::Arc<crate::testing::harness::Logs>);
...
mod bundled_oracle {
    ...
    fn the_bundled_timers_test_plugin_passes() {
        ...
        crate::api::lifecycle::notify_unload(&rt, &ctx, &api);
        crate::api::lifecycle::dispose(&ctx, &api);
        dispose(&ctx, &timers);
    ...
    fn set_app_visible(
        ...
        crate::api::lifecycle::app_visibility_changed(rt, ctx, api, visible);
    }
