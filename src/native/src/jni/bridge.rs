...
pub(crate) struct JniBridge {
  ...
  pub(crate) on_notification_suppress: JMethodID,
...
impl JniBridge {
  pub(crate) fn new(env: &mut Env, this: &JObject) -> Option<Rc<JniBridge>> {
    ...
    let bridge = JniBridge {
      ...
      on_account_fetch: method(
        "accountFetch",
        "(IJILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;",
      )?,
      ...
      on_fetch: method(
        "fetch",
        "(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[B)Ljava/lang/String;",
      )?,
      ...
      on_notification_suppress: method("suppress", "(IIZ)V")?,
