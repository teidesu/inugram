...
pub struct AccountState {
    ...
    /// the read surface [`crate::telegram::reads`] installs, shared by every handle: a dispatch mints one of
...
/// hands every `Account` handle the getters in [`crate::telegram::reads`]; called once, at install
