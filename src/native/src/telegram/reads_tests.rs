...
mod grant_boundary {
    use super::*;
    use crate::api::kv::{KV_GET, KV_SET};
    ...
    fn the_bundled_grant_boundary_test_plugin_passes() {
        ...
        let (reads_state, accounts, rpc_state) = ctx.with(|ctx| {
            ...
            let rpc_state = crate::telegram::rpc::install_rpc(
                &ctx,
                rpc_host,
                views,
                grants,
        ...
        let accounts = crate::testing::util::DisposeOnDrop::new(&ctx, accounts, crate::telegram::account::dispose);
        let rpc_state = crate::testing::util::DisposeOnDrop::new(&ctx, rpc_state, crate::telegram::rpc::dispose);
