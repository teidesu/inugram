...
impl JniBridge {
    pub(crate) fn new(env: &mut Env, this: &JObject) -> Option<Rc<JniBridge>> {
            ...
            match found {
                ...
                None => {
                    ...
                    let _ = env.throw_new(
                        ...
                        JNIString::from(format!("QuickJs.{name}{sig} is missing; the plugin engine cannot be created")),
                    );
                    None
                }
            }
        ...
        let bridge = JniBridge {
            ...
            on_account_read: method("onAccountRead", "(IILjava/lang/String;)Ljava/lang/String;")?,
            on_resolve_peer: method("onResolvePeer", "(IJLjava/lang/String;I)Ljava/lang/String;")?,
            on_account_fetch: method("onAccountFetch", "(IJILjava/lang/String;)Ljava/lang/String;")?,
            on_account_write: method("onAccountWrite", "(IJILjava/lang/String;[Ljava/lang/String;)Ljava/lang/String;")?,
            on_message_file: method("onMessageFile", "(ILjava/lang/String;)Ljava/lang/String;")?,
            on_kv: method("onKv", "(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;")?,
            on_accounts: method("onAccounts", "()Ljava/lang/String;")?,
            on_ui_toast: method("onUiToast", "(Ljava/lang/String;)V")?,
            on_ui_dialog: method("onUiDialog", "(JLjava/lang/String;)Ljava/lang/String;")?,
            on_ui_chooser: method("onUiChooser", "(JLjava/lang/String;)Ljava/lang/String;")?,
            on_ui_current_screen: method("onUiCurrentScreen", "()Ljava/lang/String;")?,
            on_open_url: method("onOpenUrl", "(Ljava/lang/String;)V")?,
            on_clipboard_read: method("onClipboardRead", "()Ljava/lang/String;")?,
            on_clipboard_write: method("onClipboardWrite", "(Ljava/lang/String;)V")?,
            ...
            on_ui_open_fragment: method("onUiOpenFragment", "(J)Ljava/lang/String;")?,
            on_ui_register_settings: method("onUiRegisterSettings", "(J)V")?,
            on_ui_unregister_settings: method("onUiUnregisterSettings", "(J)V")?,
            on_ui_invalidate: method("onUiInvalidate", "(J)V")?,
            on_ui_open_menu: method("onUiOpenMenu", "(JJLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;")?,
            on_icon_resolves: method("onIconResolves", "(ILjava/lang/String;)Z")?,
            on_action_register: method("onActionRegister", "(IILjava/lang/String;)Ljava/lang/String;")?,
            on_action_unregister: method("onActionUnregister", "(II)V")?,
            on_action_editor: method("onActionEditor", "(IJLjava/lang/String;)Ljava/lang/String;")?,
            ...
            on_canvas: method("onCanvas", "(IJLjava/lang/String;[B)Ljava/lang/String;")?,
            on_fetch: method("onFetch", "(JLjava/lang/String;Ljava/lang/String;[B)Ljava/lang/String;")?,
            on_fetch_abort: method("onFetchAbort", "(J)V")?,
            on_notification_register: method("onNotificationRegister", "(I[Ljava/lang/String;)Ljava/lang/String;")?,
            on_notification_unregister: method("onNotificationUnregister", "(I)V")?,
            on_jvm: method("onJvm", "(IJLjava/lang/String;[Ljava/lang/String;)Ljava/lang/String;")?,
            on_xposed: method("onXposed", "(IJLjava/lang/String;[Ljava/lang/String;)Ljava/lang/String;")?,
            target,
        };
        Some(Rc::new(bridge))
    }
